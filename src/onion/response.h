...
enum onion_response_flags_e{
	OR_FINISHED=4,					///< Request has been finished and will not add more data
...
/// Cleans the response object for reuse
void onion_response_clean(onion_response *res);
/// Finish the response, setting content length or finishing chunked content
void onion_response_finish(onion_response *res);
...
/// Returns if response must keep alive or not
bool onion_response_keep_alive(onion_response *req);
